...
% Pick cube at position 1, move to 4 for rotation, then return to 1
% and place
...
% Pick cube at position 2, move to 4 for rotation, then return to 2
% and place
...
% Pick cube at position 3, move to 4 for rotation, then return to 3
% and place
