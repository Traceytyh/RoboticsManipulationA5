...
holder_pos1 = [ 70, -189, 1];
holder_pos2 = [215,    0, 1]; 
holder_pos3 = [142,  143, 1];
holder_pos4 = [132, -134, 0];
holder_pos5 = [110,   -5, 0]; 
holder_pos6 = [  0,  106, 0]; 
rotate_pos4 = [100, -100, 0];

% Pick cube at position 1, move to 4 for rotation, then place at 6
...
% Pick cube at position 2, move to 4 for rotation, then stack onto 6
...
move_to(holder_pos6, 0, port_num, PROTOCOL_VERSION, DXL_ID1, DXL_ID2, DXL_ID3, DXL_ID4, ADDR_PRO_PRESENT_POSITION, ADDR_PRO_GOAL_POSITION);
holder_pos6(3) = place(holder_pos6, 0, port_num, PROTOCOL_VERSION, DXL_ID1, DXL_ID2, DXL_ID3, DXL_ID4, DXL_ID5, ADDR_PRO_PRESENT_POSITION, ADDR_PRO_GOAL_POSITION);
% Pick cube at position 3, move to 4 for rotation, then stack onto 6
...
function rad = check_radius(position) % return 1 if radius > 200, 0 if otherwise
